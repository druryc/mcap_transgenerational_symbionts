...
LOWtest <- subset_samples(coralDIV2, 
                            ...
                            sample_name =="70B"|
                            sample_name =="745C"|
                            sample_name =="83B") #subset multiple samples
...
```{r} 
#DIVs 
to_remove <- c("PCR-Pos1", "PCR-Pos2", "PCR-Neg1", "PCR_Neg2","353C","684C", "386C","10A","146C","1263B","620C","745C","70B","1255A","146B","1263A","160C","1261C","485B","315A","333C") #make list of samples to remove with less than 1500 seqs
#"151C","497C","141C","576B","620A","70A","141B","83B" add backin if 2k cutoff
...
Mcap_10_plot<-plot_bar(Mcap_10, "sample_name", fill="DIV", title="Mcap_970")+
   theme(legend.position="none");Mcap_10_plot
Mcap_120_plot<-plot_bar(Mcap_120, "sample_name", fill="DIV", title="Mcap_965")+
